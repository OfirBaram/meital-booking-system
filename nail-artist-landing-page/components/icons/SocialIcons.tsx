...
// Each returns a plain <svg> with aria-hidden; the parent <a> carries the label.
...
export function TikTokIcon(p: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...p}>
...
export function GoogleIcon(p: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...p}>
      <path d="M21.35 11.1H12.18v2.73h5.51c-.27 1.47-1.59 4.32-5.51 4.32-3.31 0-6.01-2.74-6.01-6.12s2.7-6.12 6.01-6.12c1.88 0 3.14.8 3.86 1.49l2.63-2.54C17.03 3.3 14.79 2.25 12.18 2.25 6.7 2.25 2.25 6.7 2.25 12.18S6.7 22.11 12.18 22.11c5.72 0 9.51-4.02 9.51-9.68 0-.65-.07-1.14-.34-1.33z" />
    </svg>
  )
}

export function EasyIcon(p: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...p}>
...
export function ChevronDownIcon(p: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1} strokeLinecap="round" {...p}>
