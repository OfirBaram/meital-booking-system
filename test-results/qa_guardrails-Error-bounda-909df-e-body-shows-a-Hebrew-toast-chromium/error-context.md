...
- Name: qa_guardrails.spec.js >> Error boundaries — rate limit (429) >> rate_limited error in sendOTP response body shows a Hebrew toast
- Location: tests\e2e\qa_guardrails.spec.js:235:3
