...
- Name: qa_guardrails.spec.js >> State preservation — localStorage returning-client >> phone and name are written to localStorage after a completed booking
- Location: tests\e2e\qa_guardrails.spec.js:260:3
