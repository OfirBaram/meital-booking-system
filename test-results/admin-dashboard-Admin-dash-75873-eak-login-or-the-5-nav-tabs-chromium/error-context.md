...
- Name: admin-dashboard.spec.js >> Admin dashboard — client management >> regression — client flow does not break login or the 5 nav tabs
- Location: tests\e2e\admin-dashboard.spec.js:338:3
