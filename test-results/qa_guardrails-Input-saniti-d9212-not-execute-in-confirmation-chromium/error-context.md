...
- Name: qa_guardrails.spec.js >> Input sanitization — XSS protection >> onerror-based XSS payload in name does not execute in confirmation
- Location: tests\e2e\qa_guardrails.spec.js:125:3
