...
- Name: qa_guardrails.spec.js >> data-qa structural smoke — every functional element is reachable >> step 4: OTP inputs and resend button
- Location: tests\e2e\qa_guardrails.spec.js:341:3
