...
- Name: qa_guardrails.spec.js >> Error boundaries — server offline (503) >> 503 on verifyAndBook shows a Hebrew toast and keeps the user on step 4
- Location: tests\e2e\qa_guardrails.spec.js:196:3
