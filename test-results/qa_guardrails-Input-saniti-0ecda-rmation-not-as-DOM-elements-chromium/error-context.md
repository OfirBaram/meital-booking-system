...
- Name: qa_guardrails.spec.js >> Input sanitization — XSS protection >> HTML tags in name appear as escaped text in confirmation, not as DOM elements
- Location: tests\e2e\qa_guardrails.spec.js:139:3
