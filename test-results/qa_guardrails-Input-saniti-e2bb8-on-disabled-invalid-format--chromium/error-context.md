...
- Name: qa_guardrails.spec.js >> Input sanitization — XSS protection >> XSS payload in phone field keeps Next button disabled (invalid format)
- Location: tests\e2e\qa_guardrails.spec.js:154:3
