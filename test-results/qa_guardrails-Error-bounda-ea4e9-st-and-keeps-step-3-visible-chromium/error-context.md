...
- Name: qa_guardrails.spec.js >> Error boundaries — rate limit (429) >> 429 HTTP status on sendOTP shows a Hebrew toast and keeps step 3 visible
- Location: tests\e2e\qa_guardrails.spec.js:217:3
