...
- Name: qa_guardrails.spec.js >> Error boundaries — server offline (503) >> 503 on sendOTP shows a Hebrew toast and keeps the user on step 3
- Location: tests\e2e\qa_guardrails.spec.js:175:3
