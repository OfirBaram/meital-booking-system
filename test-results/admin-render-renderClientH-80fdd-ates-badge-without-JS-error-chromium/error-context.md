...
- Name: admin-render.spec.js >> renderClientHistory — no inline onclick in DOM >> Approve button calls API and updates badge without JS error
- Location: tests\e2e\admin-render.spec.js:290:3
