...
- Name: admin-render.spec.js >> renderClientList — no inline onclick in DOM >> client list has zero onclick= attributes
- Location: tests\e2e\admin-render.spec.js:240:3
