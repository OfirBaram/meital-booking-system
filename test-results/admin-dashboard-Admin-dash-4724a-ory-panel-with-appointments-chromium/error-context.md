...
- Name: admin-dashboard.spec.js >> Admin dashboard — client management >> clicking a client card opens the history panel with appointments
- Location: tests\e2e\admin-dashboard.spec.js:290:3
...
Call log:
  ...
  - waiting for locator('#js-client-history')
    13 × locator resolved to <div class="hidden" id="js-client-history">…</div>
