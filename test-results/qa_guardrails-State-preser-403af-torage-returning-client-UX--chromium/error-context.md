...
- Name: qa_guardrails.spec.js >> State preservation — localStorage returning-client >> after reload, step 3 pre-fills phone from localStorage (returning-client UX)
- Location: tests\e2e\qa_guardrails.spec.js:274:3
