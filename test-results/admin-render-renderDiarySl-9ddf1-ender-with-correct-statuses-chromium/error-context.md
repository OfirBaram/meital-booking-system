...
- Name: admin-render.spec.js >> renderDiarySlots — no inline onclick in DOM >> all four slot rows render with correct statuses
- Location: tests\e2e\admin-render.spec.js:172:3
