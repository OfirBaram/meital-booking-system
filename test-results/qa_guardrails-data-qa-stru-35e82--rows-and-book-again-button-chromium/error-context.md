...
- Name: qa_guardrails.spec.js >> data-qa structural smoke — every functional element is reachable >> step 5: confirmation rows and book-again button
- Location: tests\e2e\qa_guardrails.spec.js:348:3
